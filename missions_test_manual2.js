...
//let NFTLinkPrefixMyPinata = 'https://alienworlds.mypinata.cloud/ipfs/'
let NFTLinkPrefixOld = 'https://ipfs.io/ipfs/'
...
async function getMissionNftImage(baseUrl, dirName, filename) {
  ...
  let statusCode = 200
  let response
  // ticket https://app.clickup.com/t/18330827/DEV-4488
  // FE uses https://ipfs.alienworlds.io vs  https://ipfs.io
  baseUrl = baseUrl.replace(NFTLinkPrefixOld, NFTLinkPrefix)
  console.log('baseUrl: Modify to AW:  ' + baseUrl)
